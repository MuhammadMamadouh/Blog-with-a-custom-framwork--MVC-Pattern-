            ...
            <div class="col-sm-12">
                <div class="box box-danger" id="ads-list">
                    <div class="box-header with-border">
                        ...
                        <button class="btn btn-danger pull-right open-popup" type="button"
                                data-modal-target="#add-ad-form" data-target="<?php echo url('/admin/ads/add'); ?>">Add
                            New Ad
                        </button>
                    </div>
                    <!-- /.box-header -->
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align: middle;">
                                        <button type="button"
                                                ...
                                                data-modal-target="#edit-ad-<?php echo $ad->id; ?>"
                                                class="btn btn-primary open-popup">
                                            Edit
                                            <span class="fa fa-pencil"></span>
                                        </button>
                                        <button data-target="<?php echo url('admin/ads/delete/' . $ad->id) ?>"
